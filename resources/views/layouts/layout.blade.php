  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if($cowFeedList==true)
        <li class="{{($url=='cow-feed' || $url=='cow-feed/create') ? 'active':''}}"> <a href="{{URL::To('cow-feed')}}"> <i class="fa fa-cutlery"></i> <span>التغذية</span> </a> </li>
        @endif
        
        @if($cowMonitorList==true || $cowVaccineMonitorList==true)
        <li class="treeview {{($url=='cow-monitor' || $url=='animal-pregnancy' || $url=='cow-monitor/create' || $url=='vaccine-monitor' || $url=='vaccine-monitor/create')?'active':''}}"> <a href="#"> <i class="fa fa-tv"></i> <span>العلاجات</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
        
            @if($cowVaccineMonitorList==true)
            <li class="{{($url=='vaccine-monitor' || $url=='vaccine-monitor/create')?'active':''}}"><a href="{{URL::to('vaccine-monitor')}}"><i class="fa fa-angle-double-right"></i>اللقاحات</a></li>
            @endif
        ...
        <li class="treeview {{($url=='sale-cow' || $url=='sale-cow/create' || $url=='sale-due-collection')?'active':''}}"> <a href="#"> <i class="fa fa-money"></i> <span>المبيعات</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            @if($saleCowList==true)
